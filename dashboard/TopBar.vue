...
<template>
  <header
    class="relative z-10 h-16 w-full items-center shadow md:h-20"
  >
      ...
      <div class="relative flex w-full items-center pl-1 sm:ml-0 sm:pr-2">
        <div class="relative left-0 flex h-full w-3/4">
          ...
          <div class="group relative flex h-full w-36 items-center lg:w-64">
            ...
            <input
              type="text"
              class="block w-full rounded-2xl bg-white py-1.5 pl-10 pr-4 leading-normal text-gray-400  focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Search"
            />
            <div
