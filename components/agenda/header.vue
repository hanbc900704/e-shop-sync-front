<template>
    <div class="flex flex-wrap items-center justify-between px-[40px] py-[16px]">
        ...
        <div class="group relative flex h-full w-36 items-center lg:w-64">
            ...
            <input
              type="text"
              class="block w-full rounded-sm bg-white py-1.5 pl-10 pr-4 leading-normal text-gray-400  focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Search"
            />
        </div>
    </div>
